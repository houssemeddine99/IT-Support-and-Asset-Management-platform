...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="dashboard-grid">
        <section class="panel ticket-panel" id="tickets">
            <div class="panel-heading"><div><h2>Priority tickets</h2><p>Requests that need your team’s attention</p></div><a href="#all-tickets">View all <i class="bi bi-arrow-right"></i></a></div>
            <div class="ticket-list">
                <article class="ticket-row"><span class="priority priority-critical"></span><div class="ticket-main"><div><span class="ticket-id">#INC-2048</span><span class="status status-critical">Critical</span></div><h3>Production server is unreachable</h3><p><i class="bi bi-building"></i> Infrastructure · Reported 18 min ago</p></div><div class="assignee"><span class="avatar avatar-indigo">MK</span><span><strong>Malek K.</strong><small>Infrastructure</small></span></div><button class="more-button" type="button" aria-label="Ticket options"><i class="bi bi-three-dots"></i></button></article>
                <article class="ticket-row"><span class="priority priority-high"></span><div class="ticket-main"><div><span class="ticket-id">#INC-2042</span><span class="status status-high">High</span></div><h3>VPN connection fails after update</h3><p><i class="bi bi-shield-lock"></i> Network · Reported 1h ago</p></div><div class="assignee"><span class="avatar avatar-cyan">SA</span><span><strong>Sarra A.</strong><small>Network</small></span></div><button class="more-button" type="button" aria-label="Ticket options"><i class="bi bi-three-dots"></i></button></article>
                <article class="ticket-row"><span class="priority priority-medium"></span><div class="ticket-main"><div><span class="ticket-id">#REQ-2039</span><span class="status status-medium">Medium</span></div><h3>New employee laptop setup</h3><p><i class="bi bi-person-plus"></i> Hardware · Reported 3h ago</p></div><div class="assignee"><span class="avatar avatar-rose">YA</span><span><strong>Yasmine A.</strong><small>Support</small></span></div><button class="more-button" type="button" aria-label="Ticket options"><i class="bi bi-three-dots"></i></button></article>
    ...
    <div class="dashboard-grid lower-grid">
        <section class="panel activity-panel" id="maintenance">
            ...
            <div class="timeline"><div class="timeline-item"><span class="timeline-icon success"><i class="bi bi-check-lg"></i></span><div><p><strong>Ticket #INC-2028 resolved</strong> by Sarra A.</p><small>Printer connection restored · 12 minutes ago</small></div></div><div class="timeline-item"><span class="timeline-icon info"><i class="bi bi-laptop"></i></span><div><p><strong>Asset LT-0147 assigned</strong> to Anis M.</p><small>Dell Latitude 5440 · 46 minutes ago</small></div></div><div class="timeline-item"><span class="timeline-icon warning"><i class="bi bi-wrench"></i></span><div><p><strong>Maintenance scheduled</strong> by Malek K.</p><small>Server SRV-003 · Today at 18:00</small></div></div></div>
        </section>
